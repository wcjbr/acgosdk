...
Future<void> main() async {
  ...
  try {
    final login = await client.loginByPassword('***********', '********');
    print(login);

    await client.sendPrivateText('4047575', 'hello');
    await client.sendPrivateEmoji('4047575', '微笑');
    await client.sendPrivateImage('4047575',
        file: '/home/archzero/图片/Wallpapers/洛天依.png');
    ...
    await client.enterExam(first['programExamId'],
